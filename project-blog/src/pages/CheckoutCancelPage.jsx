  ...
  useEffect(() => {
    const validateToken = async () => {
      try {
        ...
        const result = await validateCheckoutToken(token, 'cancel', false);
        console.log('Token validation result:', result);

        if (result.valid) {
          // Mark token as used for future visits
          await validateCheckoutToken(token, 'cancel', true);
        ...
        <div className="max-w-md w-full space-y-8 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              {error || 'Could not validate your checkout session'}
            </p>
            <div className="mt-8">
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
      <div className="max-w-md w-full space-y-8 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        <div className="text-center flex flex-col items-center justify-center gap-4 mb-2">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            You have cancelled your purchase. Your card has not been charged.
          </p>
